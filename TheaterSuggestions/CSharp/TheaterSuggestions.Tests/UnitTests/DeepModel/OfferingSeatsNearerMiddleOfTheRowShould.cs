...
namespace SeatsSuggestions.Tests.UnitTests.DeepModel
{
    internal class OfferingSeatsNearerMiddleOfTheRowShould
    {
        ...
        [Test]
        public void Offer_seats_from_the_middle_of_the_row_with_the_row_size_is_even_when_party_size_is_greater_than_one()
        {
        ...
        [Test]
        public void Offer_seats_from_the_middle_of_the_row_with_the_row_size_is_odd_when_party_size_is_greater_than_one()
        {
            var partyRequested = new PartyRequested(5);
