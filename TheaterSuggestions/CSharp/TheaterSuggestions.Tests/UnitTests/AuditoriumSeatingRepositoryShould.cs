...
namespace SeatsSuggestions.Tests.UnitTests
{
    public class AuditoriumSeatingRepositoryShould
    {
        ...
        public async Task Retrieve_and_save_auditorium_seating_instances_from_repository()
        {
            ...
            var auditoriumSeatingRepository = new AuditoriumsRepository(auditoriumSeatingAdapter);

            var auditoriumSeating1 = await auditoriumSeatingRepository.FindById(new ShowId("1"));
            
            auditoriumSeatingRepository.Save(auditoriumSeating1);
                
            var auditoriumSeating2 = await auditoriumSeatingRepository.FindById(new ShowId("1"));
            ...
            var auditoriumSeating4 = await auditoriumSeatingRepository.FindById(new ShowId("2"));
